...
def train_model(data_path,batch_size,img_height,img_width,num_classes,iter):
    ...
    save = open ('C:/Users/thomi/OneDrive/Bureau/projet_robot/dataset_model',"wb")
    dump (model,save)
    dump (img_height,save)
    dump(img_width,save)
    save.close()

train_model('C:/Users/thomi/OneDrive/Bureau/projet_robot/dataset_brouillon',3,200,200,3,50)